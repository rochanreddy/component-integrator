...
const WhatsAppButton = () => {
  const phoneNumber = "8977009403"; // Using the first phone number from contact info
  ...
  return (
    <motion.a
      ...
      whileTap={{ scale: 0.95 }}
      className="fixed bottom-6 right-6 z-50 bg-[#25D366] hover:bg-[#20BA5A] text-white rounded-full p-4 shadow-lg hover:shadow-xl transition-all duration-300 flex items-center justify-center w-14 h-14 md:w-16 md:h-16 group"
